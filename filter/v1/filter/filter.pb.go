...
var file_datatrails_common_api_filter_v1_filter_filter_proto_goTypes = []interface{}{
...
func file_datatrails_common_api_filter_v1_filter_filter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_datatrails_common_api_filter_v1_filter_filter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Filter); i {
			case 0:
				return &v.state
			case 1:
