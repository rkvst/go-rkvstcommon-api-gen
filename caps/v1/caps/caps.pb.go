...
func file_datatrails_common_api_caps_v1_caps_caps_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_datatrails_common_api_caps_v1_caps_caps_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_datatrails_common_api_caps_v1_caps_caps_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Cap); i {
			case 0:
				return &v.state
			case 1:
		...
		file_datatrails_common_api_caps_v1_caps_caps_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Caps); i {
			case 0:
				return &v.state
			case 1:
