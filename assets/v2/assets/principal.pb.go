...
var file_datatrails_common_api_assets_v2_assets_principal_proto_goTypes = []interface{}{
...
func file_datatrails_common_api_assets_v2_assets_principal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_datatrails_common_api_assets_v2_assets_principal_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
