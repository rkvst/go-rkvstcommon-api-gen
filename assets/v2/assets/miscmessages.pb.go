...
func file_datatrails_common_api_assets_v2_assets_miscmessages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_datatrails_common_api_assets_v2_assets_miscmessages_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_datatrails_common_api_assets_v2_assets_miscmessages_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_datatrails_common_api_assets_v2_assets_miscmessages_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_datatrails_common_api_assets_v2_assets_miscmessages_proto_msgTypes[3].Exporter = func(v any, i int) any {
