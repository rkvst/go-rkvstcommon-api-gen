...
type MerkleLogCommit struct {
	...
	// The mmr *leaf* index
	LeafIndex uint64 `protobuf:"varint,2,opt,name=leaf_index,json=leafIndex,proto3" json:"leaf_index,omitempty"` // TBD: this may be redundant.
	// time ordered and strictly unique per tenant. system wide
	// unique with very reasonable operational assumptions.
	Idtimestamp uint64 `protobuf:"fixed64,3,opt,name=idtimestamp,proto3" json:"idtimestamp,omitempty"`
}
...
type MerkleLogCommitMongoDB struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// duration.
	Idtimestamp string `protobuf:"bytes,3,opt,name=idtimestamp,proto3" json:"idtimestamp,omitempty"`
}

func (x *MerkleLogCommitMongoDB) Reset() {
	*x = MerkleLogCommitMongoDB{}
	if protoimpl.UnsafeEnabled {
...
func (x *MerkleLogCommitMongoDB) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MerkleLogCommitMongoDB) ProtoMessage() {}

func (x *MerkleLogCommitMongoDB) ProtoReflect() protoreflect.Message {
	mi := &file_datatrails_common_api_assets_v2_assets_merklelogentry_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MerkleLogCommitMongoDB.ProtoReflect.Descriptor instead.
func (*MerkleLogCommitMongoDB) Descriptor() ([]byte, []int) {
	return file_datatrails_common_api_assets_v2_assets_merklelogentry_proto_rawDescGZIP(), []int{1}
}

func (x *MerkleLogCommitMongoDB) GetIndex() uint64 {
	if x != nil {
		return x.Index
	}
	return 0
...
func (x *MerkleLogCommitMongoDB) GetLeafIndex() uint64 {
	if x != nil {
		return x.LeafIndex
	}
	return 0
...
func (x *MerkleLogCommitMongoDB) GetIdtimestamp() string {
	if x != nil {
		return x.Idtimestamp
	}
	return ""
...
type MerkleLogEntry struct {
	...
	Commit *MerkleLogCommitMongoDB `protobuf:"bytes,3,opt,name=commit,proto3" json:"commit,omitempty"`
}
...
func (x *MerkleLogEntry) GetCommit() *MerkleLogCommitMongoDB {
	if x != nil {
		return x.Commit
	}
	return nil
...
var file_datatrails_common_api_assets_v2_assets_merklelogentry_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_datatrails_common_api_assets_v2_assets_merklelogentry_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_datatrails_common_api_assets_v2_assets_merklelogentry_proto_goTypes = []interface{}{
	...
	(*MerkleLogCommitMongoDB)(nil), // 1: archivist.v2.MerkleLogCommitMongoDB
	(*MerkleLogCommitMessage)(nil), // 2: archivist.v2.MerkleLogCommitMessage
	(*MerkleLogEntry)(nil),         // 3: archivist.v2.MerkleLogEntry
	(*timestamppb.Timestamp)(nil),  // 4: google.protobuf.Timestamp
}
var file_datatrails_common_api_assets_v2_assets_merklelogentry_proto_depIdxs = []int32{
	4, // 0: archivist.v2.MerkleLogCommitMessage.timestamp:type_name -> google.protobuf.Timestamp
	0, // 1: archivist.v2.MerkleLogCommitMessage.commit:type_name -> archivist.v2.MerkleLogCommit
	1, // 2: archivist.v2.MerkleLogEntry.commit:type_name -> archivist.v2.MerkleLogCommitMongoDB
...
func file_datatrails_common_api_assets_v2_assets_merklelogentry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_datatrails_common_api_assets_v2_assets_merklelogentry_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MerkleLogCommitMongoDB); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
